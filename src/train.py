...
def parse_args():
    ...
    parser.add_argument('--verbose', type=int, default=500, help='number of epochs to show the results ans dtore model parameters.')
    parser.add_argument('--embed_size', type=int, default=64, help='Embedding size.')
    parser.add_argument('--reg', type=float, default=0, help='Regularization for user and item embeddings.')
    parser.add_argument('--lr', type=float, default=0.05, help='Learning rate.')
    parser.add_argument('--restore_epoch', type=int, default=1, help='Default is 1: The restore epochs (Must be lower than the epochs)')
